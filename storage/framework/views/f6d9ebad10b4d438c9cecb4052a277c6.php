                ...
                <div class="sticky top-32">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="<?php echo e(route('laptops')); ?>" 
                           class="flex items-center justify-between p-4 rounded-xl border transition-all duration-300 <?php echo e(!request()->has('category') ? 'bg-primary border-primary text-white shadow-lg' : 'bg-slate-900/40 border-slate-800 text-gray-400 hover:border-primary/50 hover:bg-slate-800/60'); ?>">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('laptops', ['category' => $cat->slug])); ?>" 
                               class="flex items-center justify-between p-4 rounded-xl border transition-all duration-300 <?php echo e(request('category') == $cat->slug ? 'bg-primary border-primary text-white shadow-lg' : 'bg-slate-900/40 border-slate-800 text-gray-400 hover:border-primary/50 hover:bg-slate-800/60'); ?>">
                                <div class="flex items-center gap-3">
                                    <?php
                                        $icon = 'fa-laptop';
                                    ...
                                    <span class="font-bold"><?php echo e($cat->name); ?></span>
                                </div>
            ...
            <main class="lg:w-3/4">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $laptops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="service-card group shadow-elegant" style="padding: 0; position: relative; overflow: hidden; border: 1px solid var(--glass-border); transition: var(--transition); display: flex; flex-direction: column; height: 100%; border-radius: 16px; background: rgba(30, 41, 59, 0.4); backdrop-filter: blur(10px);">
                            ...
                            <a href="https://wa.me/9613243504?text=Hello%2C%20I%20am%20interested%20in%20the%20<?php echo e(urlencode($laptop->brand . ' ' . $laptop->model)); ?>%20laptop." target="_blank" style="position: absolute; top: 1rem; right: 1rem; z-index: 10; background: #25D366; color: white; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 5px 15px rgba(0,0,0,0.3); transition: var(--transition); text-decoration: none;" class="hover:scale-110 hover:bg-green-500">
                ...
                <?php if($laptops->isEmpty()): ?>
                    <div class="text-center py-20 bg-slate-900/20 rounded-3xl border border-dashed border-slate-800">
                        ...
                        <a href="<?php echo e(route('laptops')); ?>" class="btn-primary mt-6">View all laptops</a>
                    </div>
                <?php endif; ?>
            </main>
        </div>
