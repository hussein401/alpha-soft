            ...
            <?php $__currentLoopData = $laptops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="service-card group shadow-elegant" style="padding: 0; position: relative; overflow: hidden; border: 1px solid var(--glass-border); transition: var(--transition);">
                    ...
                    <div style="height: 200px; overflow: hidden; width: 100%;">
                        <img src="<?php echo e($laptop['image']); ?>" alt="<?php echo e($laptop['brand']); ?> <?php echo e($laptop['model']); ?>" style="width: 100%; height: 100%; object-fit: cover; transition: var(--transition);" class="group-hover:scale-105">
                    </div>
