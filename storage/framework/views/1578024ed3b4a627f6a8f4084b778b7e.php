<?php $__env->startSection('title', 'Track Your Repair'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-hero">
    <div class="page-hero-bg"></div>
    <div class="container page-hero-content">
        <div class="section-tag animate-in"><?php echo e(__('Support Center')); ?></div>
        <h1>Track Your <span class="text-gradient">Repair</span></h1>
        <p><?php echo e(__('Enter your Repair ID to see the real-time status of your device in our workshop.')); ?></p>
    </div>
</div>
                ...
                <div class="grid md:grid-cols-2 gap-6" style="font-size: 0.9rem;">
                    <div class="space-y-4">
                        <div class="flex justify-between border-b border-white/5 pb-2">
                            <span class="text-muted"><?php echo e(__('Device')); ?></span>
                            <span style="color: var(--white);">MacBook Pro 14" (M2 Pro)</span>
                        </div>
                        <div class="flex justify-between border-b border-white/5 pb-2">
                            <span class="text-muted"><?php echo e(__('Reported Issue')); ?></span>
                            <span style="color: var(--white);">Battery not charging</span>
                        </div>
                    </div>
                    <div class="space-y-4">
                        <div class="flex justify-between border-b border-white/5 pb-2">
                            <span class="text-muted"><?php echo e(__('Estimated Ready Date')); ?></span>
                            <span style="color: var(--white);">Tomorrow, 2:00 PM</span>
                        </div>
                        <div class="flex justify-between border-b border-white/5 pb-2">
                            <span class="text-muted"><?php echo e(__('Service Fee')); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\alpha-soft\resources\views\pages\repairs.blade.php ENDPATH**/ ?>